...
@section('content')
    <div class="mx-auto max-w-xl">
        <h2 class="flex items-center gap-2 text-2xl font-semibold tracking-tight">
            <i class="fa-solid fa-folder-plus text-teal-600 dark:text-teal-400"></i>
            Yeni proje
        </h2>
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Erişim anahtarı kayıt sırasında otomatik üretilir.</p>

        @if ($clients->isEmpty())
            <div class="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-6 text-sm text-amber-900 dark:border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-200">
