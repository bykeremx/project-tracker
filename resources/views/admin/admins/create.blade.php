...
@section('content')
    <div class="mx-auto max-w-xl">
        ...
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Bu hesap panele giriş yapabilir.</p>

        <form method="POST" action="{{ route('admin.admins.store') }}" class="card mt-8 space-y-5 p-6">
            @csrf
